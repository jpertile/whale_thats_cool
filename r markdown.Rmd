...
box()
# add the points
points(valpraiso$Lon, valpraiso$Lat, col='orange', pch=20, cex=0.75)
# plot points again to add a border, for better visibility
points(valpraiso$Lon, valpraiso$Lat, col='red', cex=0.75)
```
...
box()
# add the points
points(right_whales$Lon, right_whales$Lat, col='orange', pch=20, cex=0.75)
# plot points again to add a border, for better visibility
points(right_whales$Lon, right_whales$Lat, col='red', cex=0.75)
```
